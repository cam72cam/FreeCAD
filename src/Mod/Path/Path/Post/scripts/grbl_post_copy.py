...
from Path.Post.scripts.base import PostProcessorBase, PostProcessorArgument
...
class PostProcessor(PostProcessorBase):
    ...
    BCNC = PostProcessorArgument.bool("bCNC", False,
        "Add Job operations as bCNC block headers")


    def comment(self, gcodestr, comment):
        return "%s (%s)".format(gcodestr, comment)
